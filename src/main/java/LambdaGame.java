...
public class LambdaGame extends JFrame{
    ...
    LambdaGame(){
        ...
        myButton.addActionListener(
                ...
                (e) -> System.out.println("This text was created using Lambda")
        ...
        myButton2.addActionListener(
                ...
                (e) -> System.out.println("This text was also created using Lambda")
